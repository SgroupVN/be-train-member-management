...
const creatSql = `CREATE TABLE user ( id INT NOT NULL AUTO_INCREMENT , username VARCHAR(50) , salt VARCHAR(255) , password VARCHAR(255) , name VARCHAR(255) NOT NULL , age INT unsigned, gender BOOLEAN , email VARCHAR(255) NOT NULL, passwordResetToken VARCHAR(255), passwordResetExpiration DATETIME, passwordLastResetDate DATETIME, PRIMARY KEY (id), UNIQUE(username) )`;
